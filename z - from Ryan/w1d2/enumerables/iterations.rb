...
p [1, 3, 5].bubble_sort! { |num1, num2| num2 <=> num1 } #sort ascending

my_arr = [5, 4, 3, 2, 1, 0, -1, 3, 12, 5]
# p [3, 2, 1].bubble_sort
# p my_arr
...
def substrings(string)
  result = []
  string.chars.each_with_index do |ch1, i|
    string.chars.each_with_index do |ch2, j|
      result << string[i..j] unless j < i
    end
  end
  result.uniq
end
