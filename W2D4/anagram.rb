...
def second_anagram(str1, str2)
  ...
  # arr1.each_with_index do |el1, idx1|
  #   (0..)
  #   arr2.each_with_index do |el2, idx2|
  #     if el1 == el2
  #       arr1.delete_at(idx1)
  #       arr2.delete_at(idx2)
  #     end
...
def fourth_anagram(str1, str2)
  ...
  hash.keys.length == str1.length && #O(n)
  hash.keys.length == str2.length && #O(n)
  hash.values.all? { |i| i % 2 == 0 } #O(n)

#TA's way
  str1.each_char { |char| hash[char] += 1 } #O(n)
  str2.each_char { |char| hash[char] -= 1 } #O(n)

  hash.values.all? { |i| i == 0 } #O(n)
end
puts fourth_anagram("ellvis", "livesss")
